...
typedef NS_ENUM(NSUInteger, MenuItemType) {
    ...
    kMenuItemTypePlaySourceCustom,
    kMenuItemTypePlaySourceItunes,
//    kMenuItemTypePlaySourceUpdateItunes,
    kMenuItemTypeEnableMusicDefault,
    kMenuItemTypeEnableMusicNormal,
    kMenuItemTypeEnableMusicMute,
//    kMenuItemTypePlayControlBefore,
//    kMenuItemTypePlayControlReplay,
//    kMenuItemTypePlayControlAfter,
};
