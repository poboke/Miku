...
@class DVTStateToken, IDESelection, IDEWorkspace, IDEWorkspaceDocument,
    IDEWorkspaceTabController, NSString;

//@interface IDEViewController : DVTViewController <IDESelectionSource,
//DVTStatefulObject>
...
@property(copy) IDESelection
    *outputSelection; // @synthesize outputSelection=_outputSelection;
- (void)primitiveInvalidate;
- (void)revertState;
- (void)revertStateWithDictionary:(id)arg1;
- (void)setStateToken:(id)arg1;
@property(retain, nonatomic) IDEWorkspaceTabController
    *workspaceTabController; // @synthesize
                             // workspaceTabController=_workspaceTabController;
//@property(readonly) DVTStateToken *stateToken; // @synthesize
