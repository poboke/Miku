...
//<DVTControllerContentViewViewControllerAdditions, DVTEditor, DVTInvalidation>
@interface DVTViewController : NSViewController {
...
@property(retain, nonatomic) DVTExtension
    *representedExtension; // @synthesize
                           // representedExtension=_representedExtension;
