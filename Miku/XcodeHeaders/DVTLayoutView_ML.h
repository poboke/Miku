...
+ (void)_doRecursivelyLayoutSubviewsOfView:(id)arg1
             populatingSetWithLaidOutViews:(id)arg2
                completionCallBackHandlers:(id)arg3
                         currentLayoutPass:(long long)arg4
                           needsSecondPass:(char *)arg5;
+ (void)_layoutWindow:(id)arg1;
+ (void)_recursivelyLayoutSubviewsOfView:(id)arg1
           populatingSetWithLaidOutViews:(id)arg2;
...
- (void)_invalidateLayoutIfNeededAfterRegisteringRectChange:(struct CGRect)arg1
                                                    forView:(id)arg2
                                                      table:(id)arg3;
- (void)_reallyLayoutIfNeededBottomUp;
- (void)_reallyLayoutIfNeededTopDown;
- (void)_setupObservationForObservedObject:(id)arg1
                                  selector:(SEL)arg2
                          notificationName:(id)arg3
                     observationCountTable:(id *)arg4
                      rectChangeStackTable:(id *)arg5;
- (void)_tearDownObservationForObservedObject:(id)arg1
                             notificationName:(id)arg2
                        observationCountTable:(id)arg3
                         rectChangeStackTable:(id)arg4;
- (void)dealloc;
...
@property(getter=isLayoutNeeded)
    BOOL layoutNeeded; // @synthesize layoutNeeded=_layoutNeeded;
- (void)layoutBottomUp;
- (void)layoutIfNeeded;
- (void)layoutTopDown;
@property BOOL
    needsSecondLayoutPass; // @synthesize
                           // needsSecondLayoutPass=_needsSecondLayoutPass;
