...
//@class DVTDispatchLock, DVTLayoutManager, DVTNotificationToken,
//DVTObservingToken, DVTOperation, DVTSDK, DVTScopeBarController,
//DVTSourceExpression, DVTSourceLanguageService, DVTSourceTextView,
//DVTStackBacktrace, DVTTextDocumentLocation, DVTTextSidebarView,
//DVTWeakInterposer, IDEAnalyzerResultsExplorer, IDECoverageTextVisualization,
//IDENoteAnnotationExplorer, IDESchemeActionCodeCoverageFile, IDESelection,
//IDESingleFileProcessingToolbarController, IDESourceCodeDocument,
//IDESourceCodeEditorAnnotationProvider, IDESourceCodeEditorContainerView,
//IDESourceCodeHelpNavigationRequest, IDESourceCodeNavigationRequest,
//IDESourceCodeSingleLineBlameProvider, IDESourceControlLogDetailViewController,
//IDESourceLanguageEditorExtension,
//IDEViewController<IDESourceEditorViewControllerHost>,
//IDEWorkspaceTabController, NSArray, NSDictionary,
//NSImmediateActionGestureRecognizer, NSMutableArray,
//NSObject<OS_dispatch_queue>, NSOperationQueue, NSPopover, NSProgressIndicator,
//NSPulseGestureRecognizer, NSScrollView, NSString, NSTimer, NSTrackingArea,
//NSView;
@class DVTDispatchLock, DVTLayoutManager, DVTNotificationToken,
    DVTObservingToken, DVTOperation, DVTSDK, DVTScopeBarController,
    DVTSourceExpression, DVTSourceLanguageService, DVTSourceTextView,
    ...
    IDESourceControlLogDetailViewController, IDESourceLanguageEditorExtension,
    IDEViewController, IDEWorkspaceTabController, NSArray, NSDictionary,
    NSImmediateActionGestureRecognizer, NSMutableArray, NSObject,
    NSOperationQueue, NSPopover, NSProgressIndicator, NSPulseGestureRecognizer,
    NSScrollView, NSString, NSTimer, NSTrackingArea, NSView;

//@interface IDESourceCodeEditor : IDEEditor <NSTextViewDelegate,
//NSMenuDelegate, NSPopoverDelegate, DVTSourceTextViewDelegate,
//DVTFindBarFindable, IDESourceExpressionSource, IDERefactoringExpressionSource,
//IDETextVisualizationHost, IDEOpenQuicklyJumpToSupport,
//IDEComparisonEditorHostContext, IDESourceControlLogDetailDelegate,
//IDETestingSelection>
@interface IDESourceCodeEditor : IDEEditor {
  ...
  IDESingleFileProcessingToolbarController
      *_singleFileProcessingToolbarController;
  NSView *_emptyView;
...
+ (void)commitStateToDictionary:(id)arg1
             withSourceTextView:(id)arg2
         withSourceCodeDocument:(id)arg3;
...
- (id)_diagnosticAnnotationsInRange:(struct _NSRange)arg1
                        fixableOnly:(BOOL)arg2;
...
- (id)_jumpToAnnotationWithSelectedRange:(struct _NSRange)arg1
                                   fixIt:(BOOL)arg2
                               backwards:(BOOL)arg3;
- (id)_jumpToDefinitionOfExpression:(id)arg1
                    fromScreenPoint:(struct CGPoint)arg2
                         clickCount:(long long)arg3
                      modifierFlags:(unsigned long long)arg4;
...
- (void)_startPrefetchingNodeTypesInUpDirection:(BOOL)arg1
                               initialLineRange:(struct _NSRange)arg2
                           noProgressIterations:(unsigned long long)arg3;
...
//- (void)addVisualization:(id)arg1 fadeIn:(BOOL)arg2
//completionBlock:(CDUnknownBlockType)arg3;
- (void)analyzeCurrentFile;
@property(retain) IDEAnalyzerResultsExplorer *
    analyzerResultsExplorer; // @synthesize
                             // analyzerResultsExplorer=_analyzerResultsExplorer;
@property __weak DVTScopeBarController *analyzerResultsScopeBar;
- (id)annotationContextForTextView:(id)arg1;
@property(readonly) IDESourceCodeEditorAnnotationProvider
    *annotationProvider; // @synthesize annotationProvider=_annotationProvider;
...
- (id)completingTextView:(id)arg1
    documentLocationForWordStartLocation:(unsigned long long)arg2;
- (void)completingTextView:(id)arg1
    willPassContextToStrategies:(id)arg2
            atWordStartLocation:(unsigned long long)arg3;
- (BOOL)completingTextViewHandleCancel:(id)arg1;
- (void)configureStateSavingObservers;
@property(retain) IDESourceCodeEditorContainerView
    *containerView; // @synthesize containerView=_containerView;
...
@property(retain) IDECoverageTextVisualization *
    coverageTextVisualization; // @synthesize
                               // coverageTextVisualization=_coverageTextVisualization;
...
@property(retain) IDESourceLanguageEditorExtension
    *editorExtension; // @synthesize editorExtension=_editorExtension;
...
//@property __weak IDEViewController<IDESourceEditorViewControllerHost>
//*hostViewController;
@property(retain) NSImmediateActionGestureRecognizer *
    immediateActionRecognizer; // @synthesize
                               // immediateActionRecognizer=_immediateActionRecognizer;
...
@property(retain) DVTScopeBarController *
    languageServiceStatusScopeBarController; // @synthesize
                                             // languageServiceStatusScopeBarController=_languageServiceStatusScopeBarController;
@property struct _NSRange
    lastEditedCharacterRange; // @synthesize
                              // lastEditedCharacterRange=_lastEditedCharRange;
@property(retain) DVTLayoutManager
    *layoutManager; // @synthesize layoutManager=_layoutManager;
- (void)loadView;
- (id)mainScrollView;
...
@property(retain, nonatomic) DVTSourceExpression
    *mouseOverExpression; // @synthesize
                          // mouseOverExpression=_mouseOverExpression;
...
- (id)pathCell:(id)arg1
    menuItemForNavigableItem:(id)arg2
             defaultMenuItem:(id)arg3;
...
@property(retain) NSPulseGestureRecognizer *
    recognizeGestureInSideBarView; // @synthesize
                                   // recognizeGestureInSideBarView=_recognizeGestureInSideBarView;
...
//- (void)removeVisualization:(id)arg1 fadeOut:(BOOL)arg2
//completionBlock:(CDUnknownBlockType)arg3;
- (void)revealInSymbolNavigator:(id)arg1;
- (void)revertStateWithDictionary:(id)arg1;
@property(retain)
    NSScrollView *scrollView; // @synthesize scrollView=_scrollView;
- (void)selectAndHighlightDocumentLocations:(id)arg1;
- (void)selectDocumentLocations:(id)arg1;
- (void)selectDocumentLocations:(id)arg1 highlightSelection:(BOOL)arg2;
@property(retain, nonatomic) DVTSourceExpression
    *selectedExpression; // @synthesize selectedExpression=_selectedExpression;
- (struct _NSRange)selectedRangeForFindBar:(id)arg1;
- (id)selectedTestsAndTestables;
@property(readonly, nonatomic) NSString *selectedText;
- (void)setCurrentSelectedItems:(id)arg1;
@property(retain) IDESingleFileProcessingToolbarController *
    singleFileProcessingToolbarController; // @synthesize
                                           // singleFileProcessingToolbarController=_singleFileProcessingToolbarController;
@property(retain)
    DVTSourceTextView *textView; // @synthesize textView=_textView;
...
//- (void)symbolsForExpression:(id)arg1 inQueue:(id)arg2
//completionBlock:(CDUnknownBlockType)arg3;
- (id)syntaxColoringContextForTextView:(id)arg1;
- (void)takeFocus;
- (void)textDidChange:(id)arg1;
- (void)textView:(id)arg1
   clickedOnCell:(id)arg2
          inRect:(struct CGRect)arg3
         atIndex:(unsigned long long)arg4;
- (void)textView:(id)arg1
    didClickOnTemporaryLinkAtCharacterIndex:(unsigned long long)arg2
                                      event:(id)arg3
                                 isAltEvent:(BOOL)arg4;
- (void)textView:(id)arg1 didRemoveAnnotations:(id)arg2;
- (void)textView:(id)arg1
    doubleClickedOnCell:(id)arg2
                 inRect:(struct CGRect)arg3
                atIndex:(unsigned long long)arg4;
- (void)textView:(id)arg1 handleMouseDidExitSidebar:(id)arg2;
- (void)textView:(id)arg1
    handleMouseDidMoveOverSidebar:(id)arg2
                     atLineNumber:(unsigned long long)arg3;
- (void)textView:(id)arg1
    handleMouseDownInSidebar:(id)arg2
                atLineNumber:(unsigned long long)arg3;
- (long long)textView:(id)arg1
         interiorBackgroundStyle:(long long)arg2
    forInlineTokenAttachmentCell:(id)arg3;
- (id)textView:(id)arg1
          menu:(id)arg2
      forEvent:(id)arg3
       atIndex:(unsigned long long)arg4;
- (BOOL)textView:(id)arg1
    shouldChangeTextInRange:(struct _NSRange)arg2
          replacementString:(id)arg3;
- (BOOL)textView:(id)arg1
    shouldShowTemporaryLinkForCharacterAtIndex:(unsigned long long)arg2
                                 proposedRange:(struct _NSRange)arg3
                               effectiveRanges:(id *)arg4;
- (id)textView:(id)arg1
                  tokenTintColor:(id)arg2
    forInlineTokenAttachmentCell:(id)arg3;
...
//- (void)tokenizableRangesWithRange:(struct _NSRange)arg1
//completionBlock:(CDUnknownBlockType)arg2;
